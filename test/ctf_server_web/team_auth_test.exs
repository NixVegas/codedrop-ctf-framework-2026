defmodule CtfServerWeb.TeamAuthTest do
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, CtfServerWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_team/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      CtfServerWeb.Endpoint.subscribe(live_socket_id)
